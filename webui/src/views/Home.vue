                        ...
                        <b-row>
                            <b-col sm="12" md="12" lg="6" xl="6">
                                <b-form-group
                                    ...
                                    label-align="left"
                                >
                                    <b-form-input id="input-title" v-model="title" trim placeholder="Brief description"></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col sm="12" md="12" lg="6" xl="6">
                                <b-form-group
                        ...
                        <b-row>
                            <b-col sm="12" md="12" lg="6" xl="6">
                                <b-form-group
                                    ...
                                    label-align="left"
                                >
                                    <b-form-input id="input-author" v-model="author" trim placeholder="Your name"></b-form-input>
                                </b-form-group>
                            </b-col>
                            <b-col sm="12" md="12" lg="6" xl="6">
                                <b-form-group
                                ...
                                >
                                    <b-input-group>
                                        <b-input-group-prepend is-text>
                                            <b-form-checkbox switch class="mr-n2" v-model="need_password" button-variant="primary">
                                                <span class="sr-only">Switch for following text input</span>
                                            </b-form-checkbox>
                                        </b-input-group-prepend>
                                        <b-form-input v-model="password" :disabled="!need_password" placeholder="Enter a password"></b-form-input>
                                    </b-input-group>
                                </b-form-group>
                            </b-col>
                        </b-row>
...
export default {
    ...
    methods: {
        paste() {
            ...
            this.$ajax.post("http://localhost:8081/v1/add", payload, {headers:header}).then(response => {
