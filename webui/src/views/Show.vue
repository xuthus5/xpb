        ...
        <b-col xl="8" lg="8" md="8" sm="12">
          <b-card :title="record.title" :sub-title="getSubInfo()">
            ...
            <b-card-text>
              ...
              <p class="text-left text-danger mt-0 pt-0" v-if="infoNeedShow">This paste expires on 2021-03-29.</p>
            </b-card-text>
...
export default {
  ...
  created() {
    ...
    this.$ajax.get("http://192.168.3.3:8080/v1/get?sk=" + sk, {headers: header}).then(response => {
